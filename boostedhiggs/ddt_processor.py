...
class DDTProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        events.FatJet.array.content["gruTwoProng"] = run_model(events.FatJet.flatten())
        ...
        def fill(region, systematic=None, wmod=None):
            ...
            output['jet_kin'].fill(
                ...
                jet_rho=normalize(2*np.log(candidatejet.msoftdrop/candidatejet.pt), cut),
                jet_twoProngGru=normalize(candidatejet.gruTwoProng, cut),
            )

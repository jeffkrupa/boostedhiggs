...
events = NanoEvents.from_file(
    ...
    #'root://cmseos.fnal.gov//store/user/lpcbacon/jkrupa/nanopost_process/6Aug20/QCD_HT1000to1500_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8/nano_mc_2017_9QCD_HT1000to1500_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8.root',
...
x = out['templates'].sum('dataset','pt','msd','gruddt','in_v3_ddt','mu_pt').integrate('region','ttbar_muoncontrol')
hist.plot1d(x)

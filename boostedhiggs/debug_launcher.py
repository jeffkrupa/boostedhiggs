...
p = ZQQProcessor(year='2016',region=['signal','muonCR','VtaggingCR'])
out = p.process(events)
print(out)
p = ZQQProcessor(year='2016',region='signal')
out = p.process(events)
print(out)
p = ZQQProcessor(year='2016',region='muonCR')
out = p.process(events)
print(out)
p = ZQQProcessor(year='2016',region='VtaggingCR')
out = p.process(events)
print(out)
